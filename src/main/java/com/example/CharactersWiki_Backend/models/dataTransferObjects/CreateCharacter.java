...
public record CreateCharacter(
        ...
        @Nullable List<Integer> allegianceIds,
        @Nullable List<Integer> familyIds,
        @Nullable List<Integer> childrenIds,
        @Nullable List<Integer> loveInterestsIds,
        @Nullable List<Integer> alliesIds,
        @Nullable List<Integer> enemiesIds,
        @Nullable List<Integer> weaponsIds,
        @Nullable List<Integer> quoteIds,
