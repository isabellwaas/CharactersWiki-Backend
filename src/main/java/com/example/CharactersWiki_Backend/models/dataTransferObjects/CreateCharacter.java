...
public record CreateCharacter(
        ...
        Optional<List<Integer>> allegiancesIds,
        Optional<List<Integer>> familyIds,
        Optional<List<Integer>> childrenIds,
        Optional<List<Integer>> loveInterestsIds,
        Optional<List<Integer>> alliesIds,
        Optional<List<Integer>> enemiesIds,
        Optional<List<Integer>> weaponsIds,
        Optional<List<Integer>> quotesIds,
